...
public: // iterator
  ...
  typedef typename data_structure::FixedEdgeDirectedGraph<motif::MotifStateEnsemble>::const_iterator
    const_iterator;
  typedef typename data_structure::FixedEdgeDirectedGraph<motif::MotifStateEnsemble>::iterator
    iterator;
...
public: // iterator
  ...
  typedef typename data_structure::FixedEdgeDirectedGraph<motif::MotifStateEnsembleOP>::const_iterator
    const_iterator;
  typedef typename data_structure::FixedEdgeDirectedGraph<motif::MotifStateEnsembleOP>::iterator
    iterator;
...
void
motif_state_ensemble_graph_from_csv_file(
  String const &,
  MotifStateEnsembleGraph & /* return */
);
