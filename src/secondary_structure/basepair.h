...
public:
  ...
  inline Basepair(Basepair const &bp) : primitives::Basepair(bp) {}

  inline Basepair(String const &s, util::Uuid const &res1_uuid,
                  util::Uuid const &res2_uuid, util::Uuid const &uuid)
      : primitives::Basepair(res1_uuid, res2_uuid, uuid) {
    auto spl = base::split_str_by_delimiter(s, " ");
    expects<BasepairException>(spl.size() == 2,
...
public:
  inline bool operator==(Basepair const &bp) const {
