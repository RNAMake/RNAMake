...
ThermoFlucSimulation::ThermoFlucSimulation() {
  ...
  check_nodes_1_ = Indexes{};
  check_nodes_2_ = Indexes{};
  setup_ = 0;
  setup_options();
}

void ThermoFlucSimulation::setup(
...
int ThermoFlucSimulation::run() {

  if (!setup_) {
    throw ThermoFlucSimulationException("tried to execute run() without first "
                                        "calling setup, this will segfault");
  }
...
void ThermoFlucSimulation::setup_options() {
...
void ThermoFlucSimulation::update_var_options() {
