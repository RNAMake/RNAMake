...
public:
  void setup(bool target_an_aligned_end) {
    target_an_aligned_end_ = target_an_aligned_end;
  }

public:
  virtual inline float score(structure::BasepairState const &,
...
public:
  ...
  Scorer *clone() const { return new FrameScorer(*this); };

public:
  inline float score(structure::BasepairState const &state_1,
...
public:
  ...
  thermo_fluctuation::graph::Scorer *clone() const {
    return new OldFrameScorer(*this);
  };
