...
motif_data_structure::MotifStateGraphOP Sampler::get_initial_state() {
...
int Sampler::next(motif_data_structure::MotifStateGraphOP msg) {
...
void Sampler::_update(motif_data_structure::MotifStateGraphOP msg) {
