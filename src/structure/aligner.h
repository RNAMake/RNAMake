...
public:
  Aligner() : BaseClass() { dummy_ = math::Point(); }

  ~Aligner() {}

public:
  virtual void align(Basepair const &ref_bp, Segment &seg) const {

    r_ = dot(ref_bp.get_ref_frame().get_transposed(),
    ...
    sugar_dist_1_ = ref_bp.get_res1_c1_prime_coord().distance(
        seg.get_aligned_end().get_res1_c1_prime_coord());
    sugar_dist_2_ = ref_bp.get_res2_c1_prime_coord().distance(
        seg.get_aligned_end().get_res1_c1_prime_coord());
    ...
    if (sugar_dist_1_ < sugar_dist_2_) {
      sugar_diff_1_ = ref_bp.get_res1_c1_prime_coord() -
                      seg.get_aligned_end().get_res1_c1_prime_coord();
      sugar_diff_2_ = ref_bp.get_res2_c1_prime_coord() -
  ...
  virtual SegmentTypeOP get_aligned(Basepair const &ref_bp,
