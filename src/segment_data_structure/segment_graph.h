...
public:
    ...
    typedef typename data_structure::FixedEdgeDirectedGraph<SegmentType>::const_iterator const_iterator;
    typedef typename data_structure::FixedEdgeDirectedGraph<SegmentType>::iterator iterator;
...
get_extra_connections(
    ...
    return std::make_shared<base::VectorContainer<data_structure::Edge> >(new_edges);
...
get_secondary_structure_graph(
    SegmentGraph const & sg) {
    return segment_data_structure::get_secondary_structure_graph<Segment, Aligner>(sg);
};
