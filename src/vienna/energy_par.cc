...
int niniodH = 320;
int TerminalAU37 = 50;
int TerminalAUdH = 370;
int DuplexInit37 = 410;
int DuplexInitdH = 360;
int TripleC37 = 100;
int TripleCdH = 1860;
int MultipleCA37 = 30;
int MultipleCAdH = 340;
int MultipleCB37 = 160;
int MultipleCBdH = 760;
...
int hairpin37[31] = {INF, INF, INF, 540, 560, 570, 540, 600, 550, 640, 650,
                     660, 670, 680, 690, 690, 700, 710, 710, 720, 720, 730,
                     730, 740, 740, 750, 750, 750, 760, 760, 770};
int hairpindH[31] = {INF, INF, INF, 130, 480, 360, -290, 130, -290, 500, 500,
                     500, 500, 500, 500, 500, 500, 500,  500, 500,  500, 500,
                     500, 500, 500, 500, 500, 500, 500,  500, 500};
int bulge37[31] = {INF, 380, 280, 320, 360, 400, 440, 460, 470, 480, 490,
                   500, 510, 520, 530, 540, 540, 550, 550, 560, 570, 570,
                   580, 580, 580, 590, 590, 600, 600, 600, 610};
int bulgedH[31] = {INF, 1060, 710, 710, 710, 710, 710, 710, 710, 710, 710,
                   710, 710,  710, 710, 710, 710, 710, 710, 710, 710, 710,
                   710, 710,  710, 710, 710, 710, 710, 710, 710};
int internal_loop37[31] = {INF, INF, 100, 100, 110, 200, 200, 210,
                           230, 240, 250, 260, 270, 280, 290, 290,
                           300, 310, 310, 320, 330, 330, 340, 340,
                           350, 350, 350, 360, 360, 370, 370};
int internal_loopdH[31] = {INF,  INF,  -720, -720, -720, -680, -130, -130,
                           -130, -130, -130, -130, -130, -130, -130, -130,
                           -130, -130, -130, -130, -130, -130, -130, -130,
                           -130, -130, -130, -130, -130, -130, -130};

int mismatchI37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
                                      ...
                                      {{70, 70, 70, 70, 70},
                                       ...
                                       {70, -30, 70, -30, 70},
                                       {70, 70, 70, 70, 10}}};
int mismatchIdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
...
int mismatchH37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
                                      ...
                                      {{20, 20, -10, -10, 0},
                                       ...
                                       {-30, -90, -30, -110, -30},
                                       {-10, -10, -10, -10, -90}}};
int mismatchHdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
...
int mismatchM37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
                                      ...
                                      {{-30, -30, -60, -60, -50},
                                       ...
                                       {-50, -50, -80, -80, -80},
                                       {-50, -60, -60, -60, -50}}};
int mismatchMdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF},
                                       {INF, INF, INF, INF, INF}},
...
int mismatch1nI37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
                                        ...
                                        {{70, 70, 70, 70, 70},
                                         ...
                                         {70, 70, 70, 70, 70},
                                         {70, 70, 70, 70, 70}}};
int mismatch1nIdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
...
int mismatch23I37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
                                        ...
                                        {{70, 70, 70, 70, 70},
                                         ...
                                         {70, -40, 70, 0, 70},
                                         {70, 70, 70, 70, 40}}};
int mismatch23IdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
...
int mismatchExt37[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
                                        ...
                                        {{-30, -30, -60, -60, -50},
                                         ...
                                         {-50, -50, -80, -80, -80},
                                         {-50, -60, -60, -60, -50}}};
int mismatchExtdH[NBPAIRS + 1][5][5] = {{{INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF},
                                         {INF, INF, INF, INF, INF}},
...
int dangle3_37[NBPAIRS + 1][5] = {
    {INF, INF, INF, INF, INF},   {-80, -170, -80, -170, -120},
    {-40, -110, -40, -130, -60}, {-50, -80, -50, -80, -60},
    {-10, -70, -10, -70, -10},   {-50, -80, -50, -80, -60},
    {-10, -70, -10, -70, -10},   {-10, -70, -10, -70, -10}};
int dangle3_dH[NBPAIRS + 1][5] = {
    {INF, INF, INF, INF, INF},      {-410, -900, -410, -860, -750},
    {-280, -740, -280, -640, -360}, {-90, -490, -90, -550, -230},
    {-70, -570, -70, -580, -220},   {-90, -490, -90, -550, -230},
    {-70, -570, -70, -580, -220},   {-70, -490, -70, -550, -220}};
int dangle5_37[NBPAIRS + 1][5] = {
    {INF, INF, INF, INF, INF}, {0, -20, -30, 0, 0},
    {-10, -50, -30, -20, -10}, {-10, -30, -10, -20, -20},
    {-20, -30, -30, -40, -20}, {-10, -30, -10, -20, -20},
    {-20, -30, -30, -40, -20}, {0, -20, -10, 0, 0}};
int dangle5_dH[NBPAIRS + 1][5] = {
    {INF, INF, INF, INF, INF},  {70, -160, 70, -460, -40},
    {330, -240, 330, 80, -140}, {690, -50, 690, 60, 60},
...
int int11_37[NBPAIRS + 1][NBPAIRS + 1][5][5] = {{{{INF, INF, INF, INF, INF},
                                                  {INF, INF, INF, INF, INF},
                                                  {INF, INF, INF, INF, INF},
                                                  {INF, INF, INF, INF, INF},
                                                  {INF, INF, INF, INF, INF}},
