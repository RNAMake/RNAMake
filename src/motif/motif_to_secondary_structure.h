...
class MotiftoSecondaryStructure {
 ...
 public:
  ...
  secondary_structure::RNAStructureOP to_secondary_structure(
      structure::RNAStructureOP const &);

 private:
  structure::ChainOP _get_next_chain(structure::RNAStructureOP const &);

  secondary_structure::RNAStructureOP _setup_basepairs_and_ends(
      secondary_structure::StructureOP &, structure::RNAStructureOP const &);
