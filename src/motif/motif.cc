...
void align_motif(structure::BasepairStateOP const& ref_bp_state,
  ...
  auto dist1 = motif_end->res1()->get_atom("C1'")->coords().distance(
      ref_bp_state->sugars()[0]);
  auto dist2 = motif_end->res2()->get_atom("C1'")->coords().distance(
      ref_bp_state->sugars()[0]);
  ...
  if (dist1 < dist2) {
    sugar_diff_1 = ref_bp_state->sugars()[0] -
                   motif_end->res1()->get_atom("C1'")->coords();
    sugar_diff_2 = ref_bp_state->sugars()[1] -
                   motif_end->res2()->get_atom("C1'")->coords();
  } else {
    sugar_diff_1 = ref_bp_state->sugars()[0] -
                   motif_end->res2()->get_atom("C1'")->coords();
    sugar_diff_2 = ref_bp_state->sugars()[1] -
