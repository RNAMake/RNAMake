...
public:
  ...
  Motif(structure::StructureOP const &structure,
      ...
      : block_end_add_(0),
        id_(util::Uuid()), structure::RNAStructure(structure, basepairs, ends) {
  }
...
public:
  ...
  inline void move(math::Vector3 const &p) { structure_->move(p); }
...
public: // getters
  ...
  inline String end_name(int i) { return ends_[i]->get_name_str(); }
