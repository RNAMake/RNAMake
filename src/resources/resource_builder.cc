...
void ResourceBuilder::build_basic_libraries() {
  auto paths = std::map<String, util::SegmentType>{
      ...
      {motif_dirs_path_ + "/tertiary_contact_hairpin_hairpin/",
       util::SegmentType::TC_HAIRPIN_HAIRPIN},
      {motif_dirs_path_ + "/tertiary_contact_junction_hairpin/",
       util::SegmentType::TC_JUNCTION_HAIRPIN},
      {motif_dirs_path_ + "/tertiary_contact_junction_junction/",
...
//     blob_ = std::vector<uint8_t>(compressed_str_.begin(),
//     compressed_str_.end());
//
//     conn.bind(1, blob_);
