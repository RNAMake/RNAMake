...
public:
   ...
   */
  SqliteLibraryException(String const &message) : std::runtime_error(message) {}
};
...
void build_sqlite_library(String const &, std::vector<Strings> const &,
                          Strings const &, String const &);

void sqlite3_escape(String &);

void sqlite3_escape(Strings &);
