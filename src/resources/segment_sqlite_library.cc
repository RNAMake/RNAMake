...
StringStringMap SegmentSqliteLibrary::get_libnames() {
...
structure::SegmentOP SegmentSqliteLibrary::get(String const &name,
                                               String const &end_id,
...
structure::SegmentOPs SegmentSqliteLibrary::get_multi(String const &name,
                                                      String const &end_id,
                                                      String const &end_name,
                                                      String const &id) {
...
int SegmentSqliteLibrary::contains(String const &name, String const &end_id,
...
String SegmentSqliteLibrary::_generate_query(String const &name,
                                             String const &end_id,
                                             String const &end_name,
                                             String const &id) {
