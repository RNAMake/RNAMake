...
{
  static char *sugar_pucker[10] = { "C3'-endo", "C4'-exo ", "O4'-endo", "C1'-exo ", "C2'-endo", "C3'-exo ", "C4'-endo", "O4'-exo ", "C1'-endo", "C2'-exo "
  };
...
void populate_nt_info(long num_residue, long **seidx, char **ResName, char *ChainID, long *ResSeq, char **Miscs, char *bseq, char **nt_info)
{
  char idmsg[BUF512];
  long i, ib;
...
void populate_nt_list(long num_residue, long **seidx, long *RY, char *bseq, char **AtomName, double **xyz, long **nt_list)
{
  long i, j, k, ib, ie;
...
void atom_list(long ds, long num_bp, long **pair_num, long **seidx, long *RY, char **bp_seq, char **AtomName, char **ResName, char *ChainID, long *ResSeq, char **Miscs, long **phos, long **c6_c8, long **sugar, long **chi)
{
...
static void get_mc_6_torsions(long num_residue, long *RY, long **bb, double **xyz, double **nt_bb_torsion)
{
  long i, idx[5];
...
void get_nt_torsion(long num_residue, double **org, double **xyz, long **nt_list, double **nt_torsion)
{
  ...
  for (i = 1; i <= num_residue; i++) {
    ...
    phase_angle = atan2(nt_torsion[i][TOR_V4] + nt_torsion[i][TOR_V1] - nt_torsion[i][TOR_V3] - nt_torsion[i][TOR_V0],
...
void output_nt_torsion(long num_residue, char **nt_info, long **nt_list, double **nt_torsion, double **ss_Zp_Dp, FILE * fp)
{
  char *bstr = "    --- ", *fmt = "%8.1f";
  char ostr[BUF512];
...
void get_nt_bb_torsion(double **nt_bb_torsion, long num_residue, long **seidx, long *RY, char **AtomName, char **ResName, char *ChainID, long *ResSeq, char **Miscs, double **xyz)
{
  char idmsg[BUF512];
...
static void get_sugar_torsions(long ds, long num_bp, long **sugar, double **xyz, double **sugar_angle)
{
  static double Pconst;
  ...
  for (i = 1; i <= ds; i++) {
    for (j = 1; j <= num_bp; j++) {
      ...
      /* phase angle and amplitude of pseudorotation */
      if (i5 == 5) {
        P_angle = atan2(sugar_angle[i][o7 + 5] + sugar_angle[i][o7 + 2] - sugar_angle[i][o7 + 4] - sugar_angle[i][o7 + 1],
...
static void print_duplex_torsions(long num_bp, long **pair_num, char **bp_seq, double **chi_angle, double **nt_bb_torsion, char *bstr, char *fmt, FILE * fp)
{
  char str[BUF512];
  long i, j, m, idx, ds = 2;
...
static void print_ss_torsions(long num_bp, long **pair_num, char **bp_seq, double **chi_angle, double **nt_bb_torsion, char *bstr, char *fmt, FILE * fp)
{
  char str[BUF512];
  long i = 1, j, m, idx;
...
static void print_duplex_sugar_conformation(long num_bp, char **bp_seq, double **sugar_angle, char *bstr, char *fmt, FILE * fp)
{
  char str[BUF512];
...
static void print_ss_sugar_conformation(long num_bp, char **bp_seq, double **sugar_angle, char *bstr, char *fmt, FILE * fp)
{
  char str[BUF512];
...
void backbone_torsion(long ds, long num_bp, long **pair_num, char **bp_seq, long **sugar, long **chi, double **xyz, double **nt_bb_torsion, FILE * fp)
{
  char *bstr = "    --- ", *fmt = "%8.1f";
...
static void check_Watson_Crick(long num_bp, char **bp_seq, double **orien, double **org, long *WC_info)
{
  char bpi[3];
...
void ref_frames(long ds, long num_bp, long **pair_num, char **bp_seq, long **seidx, long *RY, char **AtomName, char **ResName, char *ChainID, long *ResSeq, char **Miscs, double **xyz, FILE * fp, double **orien, double **org, long *WC_info, long *str_type, long irna, long **o3p_brk)
{
  static char *RingAtom[] = { RA_LIST };
  static char *rRingAtom[] =  /* Babcock also uses C1* atom! */{ " C1'", RA_LIST };
...
void bpstep_par(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org)
{
  double phi, rolltilt;
...
void helical_par(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org)
{
...
static void print_analyze_ref_frames(long ds, long num_bp, char **bp_seq, double *iorg, double *iorien, long **pair_num, char **nt_info)
{
  FILE *fp;
...
static void single_helix(long num_bp, char **bp_seq, double **step_par, double **heli_par, double **orien, double **org, FILE * fp, long **pair_num, char **nt_info)
{
  char str[BUF512];
  double **parmtx;
  long nbpm1;
...
static void double_helix(long num_bp, char **bp_seq, double **step_par, double **heli_par, double **orien, double **org, long *WC_info, FILE * fp, double **twist_rise, double *mst_orien, double *mst_org, double *mst_orienH, double *mst_orgH, long *bphlx, long istart, long istep, long bz, long *str_type, long **pair_num, char **nt_info)
{
...
void get_parameters(long ds, long num_bp, char **bp_seq, double **orien, double **org, long *WC_info, FILE * fp, double **twist_rise, double *mst_orien, double *mst_org, double *mst_orienH, double *mst_orgH, long *bphlx, long istart, long istep, long bz, long *str_type, long **pair_num, char **nt_info)
{
  double hfoi[4], mfoi[4], o1[4], o2[4];
...
void write_mst(long ds, long num_bp, long **pair_num, char **bp_seq, double *mst_orien, double *mst_org, long **seidx, char **AtomName, char **ResName, char *ChainID, long *ResSeq, double **xyz, char **Miscs, long **htm_water, double **twist_rise, char *strfile)
{
...
void print_xyzP(long parallel, long nbpm1, char **bp_seq, long **phos, double *mst_orien, double *mst_org, double **xyz, FILE * fp, char *title_str, double **aveP, long p_offset)
{
...
/* Calculate and print xyz coordinates of P atoms w.r.t. middle frame
   ...
   B- or TA-like */
void print_PP(long parallel, double **twist_rise, long num_bp, char **bp_seq, long **phos, double *mst_orien, double *mst_org, double *mst_orienH, double *mst_orgH, double **xyz, long *WC_info, long *bphlx, long abi, long **chi, FILE * fp)
{
  char *bstr = "    --- ", *fmt = "%8.2f%8.2f%8.2f";
...
void print_radius(char **bp_seq, long nbpm1, long ich, double **p_radius, double **o4_radius, double **c1_radius, long *bphlx, FILE * fp)
{
  char *bstr = "      ----", *fmt = "%10.2f";
  char str[BUF512];
  long i, j, ik;
...
void helix_radius(long ds, long num_bp, char **bp_seq, double **orien, double **org, long **phos, long **chi, double **xyz, long *bphlx, FILE * fp)
{
  double temp1, temp2;
...
void get_axis(long nvec, long **idx, long num, double **xyz, long nb, long *C1b, long *C1e, double *std_rise, double *hrise, double *haxis, double *hstart, double *hend)
{
...
static void get_poc_radius(long ds, long num_bp, long **phos, long **chi, double **xyz, double *haxis, double *hstart, double *hend, double *rave, double *rstd)
{
...
static void global_c1_c1_par(long num_bp, char **bp_seq, long **chi, double **xyz, double *haxis, double *hstart, FILE * fp)
{
...
static long with_ss_overlap(long istep, long r1, long r2, double **orien, long **ring_atom, double **xyz)
{
...
static long with_stacking(long ds, long istep, long **pair_num, double **orien, long **ring_atom, double **xyz)
{
  long i1, i2, k1, k2;
...
void base_overlap(long ds, long num_bp, long num, long num_residue, long **pair_num, long *bRY, char **bp_seq, long **seidx, char **AtomName, double **xyz, long *idx, double **orien, double **org, FILE * fp)
{
  char *fmt = " %5.2f(%5.2f)";
  long i, j, k, r1, r2;
  long **ring_atom;
...
void get_bp_zoave(long ia, long ib, double **orien, double **org, double *oave, double *zave)
{
  ...
  (d > 0.0) ? sumxyz(orien[ib] + 6, orien[ia] + 6, zave) :ddxyz(orien[ib] + 6, orien[ia] + 6, zave);
  vec_norm(zave);
}

/* Get ring atom index and linkage information in base residues: exclude Hs */
void ring_oidx(long num, long num_residue, long *RY, long **seidx, char **AtomName, double **xyz, long *idx, long **ring_atom)
{
  long i, num_ring;
  long **connect;
...
static void pia_fit(double minx, double miny, const double mid, double sclx, double scly, point * x, long cx, vertex * ix, long fudge)
{
  long c, t;
  point t1, t2;
...
static void pia_cross(double *out_s, vertex * a, vertex * b, vertex * c, vertex * d, double a1, double a2, double a3, double a4)
{
  double r1, r2;
  point dp;
...
void cehs_bppar(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org)
{
...
/* 3DNA uses the CEHS/SCHNAaP scheme but based on a newly recommended reference
   ...
   frame. */
void cehs_pars(long num_bp, long istart, long istep, long **pair_num, char **bp_seq, long **seidx, long **c6_c8, long *RY, char **AtomName, char **ResName, char *ChainID, long *ResSeq, char **Miscs, double **xyz, double *bp_orien, double *bp_org, FILE * fp)
{
...
void schnaap_global(long num_bp, long num, char **bp_seq, long **chi, double **xyz, double *bp_orien, double *bp_org, FILE * fp)
{
  char *bstr = "      --- ", *fmt = "%10.2f";
...
void compdna(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org)
{
...
void freehelix(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org)
{
...
void nuparm(double **rot1, double *org1, double **rot2, double *org2, double *pars, double **mst_orien, double *mst_org, double *hpars, long get_hpar)
{
...
void rna(double **rot1, double *org1, double *pvt1, double **rot2, double *org2, double *pvt2, double *pars, double **mst_orien, double *mst_org)
{
  double ang;
