...
public:
  ...
  inline Structure(Residues const &res, Cutpoints const cut_points)
      : _residues(std::move(res)), _cut_points(std::move(cut_points)) {}

  inline Structure(Structure const &s)
      : _residues(s._residues), _cut_points(s._cut_points) {}

  inline Structure(String const &s) {
