//
//  motif_state_tree_unittest_app.cpp
//  RNAMake
//
...
int main(int argc, const char * argv[]) {
    unittests::motif_structures::MotifStateTreeUnittest test;
    int failed = test.run_all();
    int passed = test.size() - failed;
    std::cout << "motif_data_structures_unittests/motif_tree_state_unittest.h: ";
