...
gua.alt_names.extend("MIA GDP GTP M2G 1MG 7MG G7M QUO I YG 2MG YYG OMG".split())
ade.alt_names.extend("A23 3DA 1MA 12A AET 2MA".split())
ura.alt_names.extend("PSU H2U 5MU 4SU 5BU 5MC U3H 2MU 70U BRU DT UFT".split())
cyt.alt_names.extend("CBR CCC OMC CFZ".split())
